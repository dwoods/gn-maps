...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItem.attribution'
        db.add_column(u'mediastory_mediaitem', 'attribution',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaItem.attribution'
        db.delete_column(u'mediastory_mediaitem', 'attribution')
