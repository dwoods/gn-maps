...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AudioMediaItem'
        db.create_table(u'mediastory_audiomediaitem', (
            ...
            ('audio_file', self.gf('filebrowser.fields.FileBrowseField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'mediastory', ['AudioMediaItem'])

        # Adding field 'ExternalVideoMediaItem.text'
        db.add_column(u'mediastory_externalvideomediaitem', 'text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ImageMediaItem.text'
        db.add_column(u'mediastory_imagemediaitem', 'text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AudioMediaItem'
        db.delete_table(u'mediastory_audiomediaitem')

        # Deleting field 'ExternalVideoMediaItem.text'
        db.delete_column(u'mediastory_externalvideomediaitem', 'text')

        # Deleting field 'ImageMediaItem.text'
        db.delete_column(u'mediastory_imagemediaitem', 'text')
