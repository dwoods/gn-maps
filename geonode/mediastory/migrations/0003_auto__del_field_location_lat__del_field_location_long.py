...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Location.lat'
        raise RuntimeError("Cannot reverse this migration. 'Location.lat' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Location.lat'
        db.add_column(u'mediastory_location', 'lat',
                      self.gf('django.db.models.fields.FloatField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Location.long'
        raise RuntimeError("Cannot reverse this migration. 'Location.long' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Location.long'
