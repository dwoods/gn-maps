...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoMediaItem.video_file'
        db.delete_column(u'mediastory_videomediaitem', 'video_file')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VideoMediaItem.video_file'
        raise RuntimeError("Cannot reverse this migration. 'VideoMediaItem.video_file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VideoMediaItem.video_file'
        db.add_column(u'mediastory_videomediaitem', 'video_file',
