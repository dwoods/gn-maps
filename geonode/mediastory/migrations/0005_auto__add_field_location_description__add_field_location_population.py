...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mediastory_location', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.population'
        db.add_column(u'mediastory_location', 'population',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mediastory_location', 'description')

        # Deleting field 'Location.population'
        db.delete_column(u'mediastory_location', 'population')
