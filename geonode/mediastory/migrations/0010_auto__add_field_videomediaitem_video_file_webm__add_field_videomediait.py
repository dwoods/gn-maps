...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoMediaItem.video_file_webm'
        db.add_column(u'mediastory_videomediaitem', 'video_file_webm',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'VideoMediaItem.video_file_mp4'
        db.add_column(u'mediastory_videomediaitem', 'video_file_mp4',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoMediaItem.video_file_webm'
        db.delete_column(u'mediastory_videomediaitem', 'video_file_webm')

        # Deleting field 'VideoMediaItem.video_file_mp4'
        db.delete_column(u'mediastory_videomediaitem', 'video_file_mp4')
